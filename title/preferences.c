...
void savePreferences(WTPreferences *wtp, WTApplet *wtapplet) {
	...
	panel_applet_gconf_set_bool (PANEL_APPLET(wtapplet), CFG_SHOW_WINDOW_MENU, wtp->show_window_menu, NULL);
	...
	panel_applet_gconf_set_string (PANEL_APPLET(wtapplet), CFG_TITLE_ACTIVE_FONT, wtp->title_active_font, NULL);
	panel_applet_gconf_set_string (PANEL_APPLET(wtapplet), CFG_TITLE_ACTIVE_COLOR_FG, wtp->title_active_color, NULL);
	panel_applet_gconf_set_string (PANEL_APPLET(wtapplet), CFG_TITLE_INACTIVE_FONT, wtp->title_inactive_font, NULL);
	panel_applet_gconf_set_string (PANEL_APPLET(wtapplet), CFG_TITLE_INACTIVE_COLOR_FG, wtp->title_inactive_color, NULL);
#else
...
WTPreferences *loadPreferences(WTApplet *wtapplet) {
	...
	wtp->show_window_menu = panel_applet_gconf_get_bool(PANEL_APPLET(wtapplet), CFG_SHOW_WINDOW_MENU, NULL);
	wtp->title_size = panel_applet_gconf_get_int(PANEL_APPLET(wtapplet), CFG_TITLE_SIZE, NULL);
	wtp->title_active_font = panel_applet_gconf_get_string(PANEL_APPLET(wtapplet), CFG_TITLE_ACTIVE_FONT, NULL);
	wtp->title_active_color = panel_applet_gconf_get_string(PANEL_APPLET(wtapplet), CFG_TITLE_ACTIVE_COLOR_FG, NULL);
	wtp->title_inactive_font = panel_applet_gconf_get_string(PANEL_APPLET(wtapplet), CFG_TITLE_INACTIVE_FONT, NULL);;
	wtp->title_inactive_color = panel_applet_gconf_get_string(PANEL_APPLET(wtapplet), CFG_TITLE_INACTIVE_COLOR_FG, NULL);
#else
...
void cb_show_window_menu(GtkButton *button, gpointer user_data) {
	WTApplet *wtapplet = WT_APPLET (user_data);
...
static void cb_font_active_set(GtkFontButton *widget, gpointer user_data)
{
	WTApplet *wtapplet = WT_APPLET(user_data);
...
static void cb_font_inactive_set(GtkFontButton *widget, gpointer user_data)
{
	WTApplet *wtapplet = WT_APPLET(user_data);
...
static void cb_color_active_fg_set(GtkColorButton *widget, gpointer user_data)
{
	WTApplet *wtapplet = WT_APPLET(user_data);
	GdkColor color;
